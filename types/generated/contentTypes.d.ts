...
export interface ApiExperienceExperience extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    my_role: Schema.Attribute.Relation<'oneToOne', 'api::my-role.my-role'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiExpertyExperty extends Struct.CollectionTypeSchema {
  collectionName: 'experties';
  info: {
    displayName: 'Experty';
    pluralName: 'experties';
    singularName: 'experty';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiMyRoleMyRole extends Struct.CollectionTypeSchema {
...
export interface ApiTestimonyTestimony extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    organizationLink: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    role: Schema.Attribute.String & Schema.Attribute.Required;
    testimony: Schema.Attribute.Text & Schema.Attribute.Required;
    testimonyLink: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::experty.experty': ApiExpertyExperty;
